...
import 'package:flutter_bloc_basic/core/data/remote/interceptors/cookie_interceptor.dart'
    as _i4;
import 'package:flutter_bloc_basic/core/di/local_module.dart' as _i15;
import 'package:flutter_bloc_basic/core/di/network_module.dart' as _i14;
...
import 'package:flutter_bloc_basic/src/auth/data/repository/auth_repository_impl.dart'
    as _i19;
import 'package:flutter_bloc_basic/src/auth/di/auth_di_module.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i11.ExampleUseCase>(
        () => exampleDiModule.exampleUseCase(gh<_i10.ExampleRepository>()));
    gh.singleton<_i12.AuthRepository>(authDiModule.authRepository);
    gh.factory<_i13.LoginUseCase>(
        () => authDiModule.loginUseCase(gh<_i12.AuthRepository>()));
    return this;
  }
}
...
class _$ExampleDiModule extends _i16.ExampleDiModule {
  ...
  _i17.ExampleRepositoryImpl get exampleRepository =>
      _i17.ExampleRepositoryImpl(_getIt<_i8.ExampleService>());
}

class _$AuthDiModule extends _i18.AuthDiModule {
  _$AuthDiModule(this._getIt);

  final _i1.GetIt _getIt;

  @override
  _i19.AuthRepositoryImpl get authRepository =>
      _i19.AuthRepositoryImpl(_getIt<_i9.AuthService>());
}
