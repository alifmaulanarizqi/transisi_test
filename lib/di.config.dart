...
import 'package:flutter_bloc_basic/core/data/remote/interceptors/cookie_interceptor.dart'
    as _i4;
import 'package:flutter_bloc_basic/core/di/local_module.dart' as _i18;
import 'package:flutter_bloc_basic/core/di/network_module.dart' as _i17;
...
import 'package:flutter_bloc_basic/src/auth/data/repository/auth_repository_impl.dart'
    as _i24;
import 'package:flutter_bloc_basic/src/auth/di/auth_di_module.dart' as _i23;
...
import 'package:flutter_bloc_basic/src/employee/list_employee/data/repository/employee_repository.dart'
    as _i11;
import 'package:flutter_bloc_basic/src/employee/list_employee/data/repository/employee_repository_impl.dart'
    as _i20;
import 'package:flutter_bloc_basic/src/employee/list_employee/di/employee_di_module.dart'
    as _i19;
...
class _$EmployeeDiModule extends _i19.EmployeeDiModule {
  _$EmployeeDiModule(this._getIt);

  final _i1.GetIt _getIt;

  @override
  _i20.EmployeeRepositoryImpl get employeeRepository =>
      _i20.EmployeeRepositoryImpl(_getIt<_i8.EmployeeService>());
}

class _$ExampleDiModule extends _i21.ExampleDiModule {
  _$ExampleDiModule(this._getIt);

  final _i1.GetIt _getIt;

  @override
  _i22.ExampleRepositoryImpl get exampleRepository =>
      _i22.ExampleRepositoryImpl(_getIt<_i9.ExampleService>());
}

class _$AuthDiModule extends _i23.AuthDiModule {
  _$AuthDiModule(this._getIt);

  final _i1.GetIt _getIt;

  @override
  _i24.AuthRepositoryImpl get authRepository =>
      _i24.AuthRepositoryImpl(_getIt<_i10.AuthService>());
}
